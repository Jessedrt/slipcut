...
export const PIDGIN_SLANG: Array<{ slang: string; meaning: string; use: string }> = [
  ...
  { slang: "handball", meaning: "handball", use: "sport" },
  ...
  { slang: "longshot / 1 week / 2 weeks / weekend", meaning: "spread games across days, not one day pack", use: "create" },
...
export function slangHelp(): string {
  return [
    ...
    "longshot 12 games football — spread across 1 week, no be one day",
    "weekend 10 odds bola — Saturday and Sunday only",
    "2 weeks 12 games basketball",
    "trim am — keep strong half",
    "comot game 3 and 8 — remove those matches",
    "e cut — study why e no hit",
    "12 games tennis — ATP/WTA",
    "10 games handball",
    "cook 20 odds mix — football plus basketball plus tennis plus handball",
    "no game above 1.70 — cap each selection",
    "no Palace — skip that team",
    "score — live scores",
    "my book — hit and cut history",
