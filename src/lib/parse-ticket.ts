...
const OTHER_HINT =
  /\b(table tennis|volleyball|ice hockey|virtual|esport|cricket|rugby|snooker|darts|mma|ufc|boxing|baseball|nfl|nhl)\b/i;

function guessSport(blob: string): SportKind {
  if (/\bhand\s*ball\b/i.test(blob)) return "handball";
